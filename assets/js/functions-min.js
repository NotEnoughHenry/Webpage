...
function updateDescritopn(id) {
    var opt1 = document.getElementById("opt-1");
    var opt2 = document.getElementById("opt-2");
    var opt3 = document.getElementById("opt-3");
    var opt1Text = document.getElementById("opt-1-text");
    var opt2Text = document.getElementById("opt-2-text");
    var opt3Text = document.getElementById("opt-3-text");
    switch (id) {
        case opt1.id:
            opt1.checked = true;
            opt2.checked = false;
            opt3.checked = false;
            opt1Text.style.display = "block";
            opt2Text.style.display = "none";
            opt3Text.style.display = "none";
            break;
        case opt2.id:
            opt1.checked = false;
            opt2.checked = true;
            opt3.checked = false;
            opt1Text.style.display = "none";
            opt2Text.style.display = "block";
            opt3Text.style.display = "none";
            break;
        case opt3.id:
            opt1.checked = false;
